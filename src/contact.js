              ...
              <div className="row">
                <div className="contact-leftside col-12 col-lg-5">
                  <h1 className="main-heading fw-bold">
                    Connect With Our <br /> Super Admin.
                  </h1>
                  <p className="main-hero-para">
                    Users can keep touch with our super admin and can contact with us any time.
                  </p>
                  <figure>
                    <img src="./images/c1.jpg" alt="contatUsImg" className="img-fluid"/>
                  </figure>
                </div>
                  ...
                  <form method="POST">
                    ...
                    <div class="form-check form-checkbox-style">
                      ...
                      <label class="form-check-label" className="main-hero-para">
                        I agree that the Daily-Offer-Deals may contact me at the
                        email address or phone number above
                      </label>
                    </div>

                    <button type="submit" className="btn btn-style w-100"> Send</button>
                  </form>
                </div>
              </div>
            </div>
